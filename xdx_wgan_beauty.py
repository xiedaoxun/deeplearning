...
data_path = 'dataset_gan/beauty_data/data1' # 数据集存放路径
...
save_path = 'dataset_gan/train_result/wgan_beauty1' #训练时生成图片保存路径
...
#     write = SummaryWriter(log_dir=virs, comment='loss')
    ...
    for epoch in iter(epochs):
        ...
        if (epoch + 1) % save_every == 0:
            ...
            torch.save(netd.state_dict(), 'dataset_gan/models/wgan/beauty1/netd_%s.pth' % epoch)
            torch.save(netg.state_dict(), 'dataset_gan/models/wgan/beauty1/netg_%s.pth' % epoch)
